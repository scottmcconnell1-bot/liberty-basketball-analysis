...
# Use new ball detection with lower confidence
ball_csv = 'ball_q1_conf00005_stride4.csv'  # we will generate this if not exists
try:
    ball_df = pd.read_csv(ball_csv)
except FileNotFoundError:
    print(f'{ball_csv} not found, falling back to ball_q1_conf0001_stride4.csv')
...
def main():
    ...
    ball_csv = f'{base}/ball_q1_conf00005_stride4.csv'
    signal_csv = f'{base}/signal_full.csv'
    db_path = f'{base}/film_analysis.db'
    output_csv = f'{base}/final_events_lower_conf.csv'
