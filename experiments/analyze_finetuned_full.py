...
video_path = os.path.join(base_dir, 'uploads', 'Liberty_Vs_Riverstone_Q1.webm')
hoop_path = os.path.join(base_dir, 'hoop_Q1.npy')
ball_path = os.path.join(base_dir, 'ball_finetuned_2min_stride16.csv')
