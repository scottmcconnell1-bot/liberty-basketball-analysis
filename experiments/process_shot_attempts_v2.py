...
# Parameters
SMOOTH_WINDOW = 7  # frames for moving average (increase for more smoothing)
PEAK_ORDER = 2     # how many points on each side to use for argrelextrema
MIN_VERTICAL_RISE_FT = 0.5  # minimum rise from start to peak to count as shot attempt (lowered)
MAKE_FRAMES_BELOW = 2       # consecutive frames below rim to count as make
THREEPT_DISTANCE_FT = 21.5  # slightly lower corner three to allow for error
SIGNAL_WINDOW_SEC = 0.7     # seconds around attempt to look for referee signal
...
def main():
    ball_csv = 'ball_q1_conf001_stride8.csv'
    pose_csv = 'pose_keypoints_full.csv'
    signal_csv = 'signal_full.csv'
    output_csv = 'final_events_v2.csv'
