...
| --- | --- | --- |
| Unit/integration tests | `python3 -m pytest tests/ -q` | **331 passed, 1 skipped** |
...
| Transfer bundle build | `bash scripts/build_transfer_bundle.sh` | creates `transfer-bundles/*.tar.gz` |
