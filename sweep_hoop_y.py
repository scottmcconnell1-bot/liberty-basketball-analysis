...
scale_ft_per_px = hoop_base['scale_ft_per_px']  # scale depends on radius, which we keep constant? Actually if we change y but keep radius same, scale unchanged.
# We'll keep radius and scale as from base.
...
def main():
    ...
    # Sweep hoop y from 200 to 400 in steps of 10
    best = None
    best_score = 1e9
